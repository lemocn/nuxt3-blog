  ...
  <div id="default-layout" :class="{'in-about': inAbout}">
    ...
    <footer id="footer" class="flex w100">
      <div class="middle flexc">
        ...
        <span class="flex"><a class="rss" target="_blank" href="/sitemap.xml" title="rss">RSS <svg-icon name="rss" /></a>| Powered By <a class="nuxt" href="https://github.com/lemocn/nuxt3-blog" target="_blank">nuxt3-blog</a></span>
      </div>
    </footer>
